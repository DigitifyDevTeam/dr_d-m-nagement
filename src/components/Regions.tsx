      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="section-subtitle mt-4">
            + 60 techniciens à disposition de nos clients dans toute la France pour un service de qualité.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <div className="inline-flex items-center gap-3 bg-primary-50 text-primary-700 px-6 py-3 rounded-xl">
            ...
            <span className="font-semibold">+ 60 techniciens à disposition de nos clients</span>
          </div>
        </div>
      </div>
    </section>
