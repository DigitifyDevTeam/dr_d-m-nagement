  ...
  const features = [
    {
      ...
      description: 'Nos techniciens sont des professionnels du déménagement certifiés et assurés, garantissant un service de qualité.',
    ...
    },
    {
      ...
      description: 'Devis détaillé et tarifs clairs sans surprise. Un service professionnel à prix compétitif pour votre déménagement.',
    ...
    },
    {
      ...
      description: 'Notre équipe vous contacte directement sous 24h avec un devis personnalisé adapté à vos besoins.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-10 lg:mb-12">
          ...
          <p className="section-subtitle mt-4">
            Faites confiance à notre équipe de professionnels expérimentés pour un service de qualité et un déménagement réussi.
          </p>
        </div>
