export default function Footer() {
  ...
  const footerLinks = {
    services: [
      { name: 'Déménagement particulier', href: '#' },
      { name: 'Déménagement entreprise', href: '#' },
      { name: 'Garde-meuble', href: '#' },
      { name: 'Monte-meuble', href: '#' },
    ...
    support: [
      ...
      { name: 'Aide', href: '#' },
      { name: 'Calculateur de volume', href: '#' },
    ],
    legal: [
          ...
          <div className="grid lg:grid-cols-6 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                Comparez les devis de déménageurs professionnels et économisez jusqu'à 40% sur votre déménagement. Service gratuit et sans engagement.
              </p>
              ...
              <div className="space-y-3">
                <a href="tel:0605992510" className="flex items-center gap-3 text-gray-300 hover:text-primary-400 transition-colors">
                  ...
                  <span className="font-semibold">06 05 99 25 10</span>
                </a>
                <a href="mailto:contact@doctordemenagement.com" className="flex items-center gap-3 text-gray-300 hover:text-primary-400 transition-colors">
                  <div className="w-10 h-10 bg-dark-700 rounded-lg flex items-center justify-center">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <span>contact@doctordemenagement.com</span>
                </a>
                <div className="flex items-start gap-3 text-gray-300">
                  ...
                  <span className="pt-2">55 av. de Paris<br />94300 Vincennes</span>
                </div>
              </div>
            ...
            <div className="lg:col-span-4 grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              {/* Company */}
              <div>
                <h4 className="font-display font-bold text-white mb-4">L'entreprise</h4>
                <ul className="space-y-3">
              ...
              {/* Support */}
              <div>
                <h4 className="font-display font-bold text-white mb-4">Aide</h4>
                <ul className="space-y-3">
